...
const App = () => {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      // Define the URL1
		// Add actual azure code
      const url = "https://nicoforecasting.azurewebsites.net/api/forecast/070f528c-2f8a-4399-a599-cfb71faee319/746b5af1-ea1f-4081-b3f0-d48abd7313a1?code={code}";
